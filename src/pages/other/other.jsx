...
import car from "../../assets/Mask group (10).png"
import car2 from "../../assets/image 22.png"
    ...
    <div>
          ...
          <div className='flex justify-around items-center flex-wrap gap-[50px]'>
            <div className='w-[300px]'>
              <img src={car2} alt="" />
              <p><b>{t("Sections7.10")}</b></p>
              <p>{t("Sections7.11")}</p>
              <br/>
              <button className='w-[100%] border border-[#ED9121] text-[#ED9121] h-[50px] rounded-[15px]'>{t("Sections7.12")}</button>
            </div>
